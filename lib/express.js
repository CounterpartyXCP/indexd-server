...
module.exports = function initialize (adapter, opts) {
  ...
  router.get('/a/:address/utxos', (req, res) => {
    ...
    try {
      ...
      if (req.params.address.startsWith('bc') || req.params.address.startsWith('tb')) {
        // Regtest starts with 'bc' too
        let b32res = bech32.decode(req.params.address)
        ...
        script = bitcoin.address.toOutputScript(req.params.address, network)
      }
